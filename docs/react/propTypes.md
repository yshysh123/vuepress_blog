...
:::tip
随着您的应用程序的增长，您可以通过类型检查捕获大量错误。对于某些应用程序，您可以使用诸如 Flow 或 TypeScript 之类的 JavaScript 扩展来检查整个应用程序。但即使你不使用它们，React 也有一些内置的类型检查功能。要对组件的 props 进行类型检查，可以指定特殊 propTypes 属性
:::
